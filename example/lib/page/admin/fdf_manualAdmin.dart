...
void main() => runApp(Fdf_manual_admin());

class Fdf_manual_admin extends StatefulWidget {
  @override
  _Fdf_manual_adminState createState() => _Fdf_manual_adminState();
}

class _Fdf_manual_adminState extends State<Fdf_manual_admin> {
  String path;
