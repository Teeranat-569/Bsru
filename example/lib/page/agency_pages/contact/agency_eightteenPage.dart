...
class AgencyEightteen extends StatefulWidget {
  @override
  _AgencyEightteenState createState() => _AgencyEightteenState();
}

class _AgencyEightteenState extends State<AgencyEightteen> {
  @override
    ...
    return  Scaffold(
      ...
      // ),
       appBar: AppBar(
          ...
          title: Text("สถาบันขงจื๊อ",style: TextStyle(color: Colors.black),),
          titleSpacing: 00.0,
          centerTitle: true,
          toolbarHeight: 40,
          elevation: 0.00,
  ...
  Widget showImage() {
    return Container(
      ...
      child: Image.asset('images/hp.jpg'),
    );
  }
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              TextButton(
                  onPressed: () async {
                    const url = 'http://cibsru.th.chinesecio.com/';
                  ...
                  child: Text('http://cibsru.th.chinesecio.com/'))
            ],
          ),
        ));
  }
          ...
          child: Row(
            ...
            children: [
              ...
              TextButton(
                  ...
                  child: Text('https://www.facebook.com/สถาบันขงจื๊อ'))
            ],
          ),
        ));
  }
