...
class AgencyTwenty extends StatefulWidget {
  @override
  _AgencyTwentyState createState() => _AgencyTwentyState();
}
...
class _AgencyTwentyState extends State<AgencyTwenty> {
  ...
  Widget showImage() {
    return Container(
      ...
      // color: Colors.green,
      child: Image.asset('images/gk.jpg'),
    );
  }
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              TextButton(
                  onPressed: () async {
                    const url = 'http://academic.bsru.ac.th/';
                  ...
                  child: Text('http://academic.bsru.ac.th/'))
            ],
          ),
        ));
  }
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              TextButton(
                  onPressed: () async {
                    const url = 'https://www.facebook.com/academic.bsru';
                    if (await canLaunch(url)) {
                      await launch(url);
                    } else {
                      throw 'Couid not launch $url';
